...
<div class="wrap">
            ...
            <div id="request-call-list" class="tab-page container-fulid grid">
                ...
                <div class="row">
                    ...
                    <div class="col-8 col-md-9 text-center">
                        <div class="row">
                            <div class="col-12 col-sm-6 text-center bold"><?php _e("Name", "") ?></div>
                            <div class="col-12 col-sm-6 text-center bold"><?php _e("Phone Number", "") ?></div>
                        </div>
                    </div>
                </div>
    ...
    <!-- wordpress nounce -->
    <input id="security" type="hidden" name="security" value="<?php echo wp_create_nonce("remove_request_call_nonce") ?>">
    <input id="action" type="hidden" name="action" value="remove_request_call">
    <!-- referral url -->
    <input id="referralUrl" type="hidden" name="referralUrl" value="<?php echo admin_url("admin-ajax.php"); ?>">
</div>